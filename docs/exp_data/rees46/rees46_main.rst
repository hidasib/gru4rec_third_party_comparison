   ...
   .. tab-item:: Metric
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_torch_gru4rec_metrics_bpr-max.csv
               :header-rows: 1
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_torch_gru4rec_metrics_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric Diff
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_torch_gru4rec_metrics_change_bpr-max.csv
               :header-rows: 1
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_torch_gru4rec_metrics_change_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Hyperparameters
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Hyperparameters used in the experiment
               :class: striped_table
               :file: /data_sources/rees46_torch_gru4rec_hyperp_bpr-max.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_recpack_metrics_bpr-max.csv
               :header-rows: 1
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_recpack_metrics_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric Diff
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_recpack_metrics_change_bpr-max.csv
               :header-rows: 1
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_recpack_metrics_change_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Hyperparameters
      ...
      .. tab-set::
         ...
         .. tab-item:: BPR-Max
            ...
            .. csv-table:: Hyperparameters used in the experiment
               :class: striped_table
               :file: /data_sources/rees46_recpack_hyperp_bpr-max.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric
      ...
      .. tab-set::
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_gru4rec_tensorflow_metrics_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric Diff
      ...
      .. tab-set::
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_gru4rec_tensorflow_metrics_change_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric
      ...
      .. tab-set::
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metrics
               :class: striped_table
               :file: /data_sources/rees46_keras_gru4rec_metrics_cross-entropy.csv
               :header-rows: 1
   ...
   .. tab-item:: Metric Diff
      ...
      .. tab-set::
         ...
         .. tab-item:: Cross-Entropy
            ...
            .. csv-table:: Metric difference compared to the "Best params" version with the corresponding loss
               :class: striped_table
               :file: /data_sources/rees46_keras_gru4rec_metrics_change_cross-entropy.csv
               :header-rows: 1
